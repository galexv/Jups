                 ...
                 double NU, double NU_BIN, double* TMI)
{
  ...
  */
  ...
  BB_TOP_OF_ATM = 5.67E-8 * (pow(TEMPS[0],4.0)) / 3.1415;
  ...
  BB_BOTTOM_OF_ATM = 5.67E-8 * (pow(TEMPS[NEW_NLAYER-1],4.0)) / 3.1415;
  ...
  for(J=0; J<NEW_NLAYER; J++)
  {
    ...
    B_SPECTRAL_DENSITY_VAL = 5.67E-8 * (pow(TEMPS[J],4.0)) / 3.1415;
