...
/* File names */
#define OUTPUT_PREFIX "OUT/Spec_0_low_grav_clear_phase_0.0_inc_0.45"      /* output name */
#define T_P_3D_FILE "DATA/Final_low_grav_clear_phase_0.0_inc_0.45.txt"         /* input file */
...
/* Planet parameters */
#define INCLINATION 0.45        /* Planet inclination in radians            */
